...
(function() {
    ...
    function extractSeasonsFromDOM(activePage) {
        ...
        for (let i = 0, len = seasonCards.length; i < len; i++) {
    ...
    async function renderEpisodesSection(seriesId, seasons, targetEpisode, nextUpHeaderText) {
        ...
        let targetSeasonId; let targetSeasonIndex; let targetSeasonName;
    ...
    async function processSeriesPage(seriesId) {
        ...
        // Get NextUp episode
        const targetEpisode = await fetchNextUpEpisode(seriesId);
