...
(function(JE) {
        ...
        try {
            ...
            results.forEach(r => {
                if (r.type === 'tv') {
                    ...
                    tvHasMorePages = (r.data.totalPages || 1) > 1;
                } else {
                    cachedMovieResults = r.data.results || [];
                    movieHasMorePages = (r.data.totalPages || 1) > 1;
                }
            });
    ...
    async function renderTagDiscovery() {
        ...
        try {
            ...
            tvHasMorePages = (tvResponse.totalPages || 1) > 1;
            movieHasMorePages = (movieResponse.totalPages || 1) > 1;
